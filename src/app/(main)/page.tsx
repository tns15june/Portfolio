  ...
  return (
    <>
      ...
      <section className="relative overflow-hidden gradient-mesh min-h-[85vh] flex items-center">
        ...
        <div className="absolute top-20 right-10 w-72 h-72 bg-primary/40 rounded-full blur-3xl animate-float opacity-30" />
        <div className="absolute bottom-20 left-10 w-96 h-96 bg-secondary/40 rounded-full blur-3xl animate-float opacity-30" style={{ animationDelay: '1s' }} />
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] bg-accent/20 rounded-full blur-3xl animate-rotate-slow opacity-20" />
      </section>
